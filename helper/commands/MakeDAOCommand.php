...
class MakeDAOCommand extends Command
{
    protected function configure()
    {
        $this
            ...
            ->setDescription('创建dao类, 如make:dao domain Dummy')
            ->setHelp('如: php helper make:dao domain Dummy')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $dir = SYS_ROOT . DIRECTORY_SEPARATOR . $input->getArgument('app') . DIRECTORY_SEPARATOR . 'dao';
        if (!$fs->exists($dir)) {
